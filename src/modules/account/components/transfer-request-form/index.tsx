      ...
      <div className="grid sm:grid-cols-2 items-center gap-x-8 gap-y-4 w-full">
        <div className="flex flex-col gap-y-1">
          ...
          <Text className="text-base-regular text-neutral-500">
            Não encontrou o pedido que procura?
        ...
        >
          <div className="flex flex-col gap-y-2 w-full">
            <Input className="w-full" name="order_id" placeholder="ID do pedido" />
            <SubmitButton
              variant="secondary"
          ...
          <div className="flex gap-x-2 items-center">
            ...
            <div className="flex flex-col gap-y-1">
              <Text className="text-medim-pl text-neutral-950">
                Transferência para o pedido {state.order?.id} solicitada
              </Text>
              <Text className="text-base-regular text-neutral-600">
                E-mail de solicitação de transferência enviado para {state.order?.email}
              </Text>
            </div>
          </div>
          <IconButton
