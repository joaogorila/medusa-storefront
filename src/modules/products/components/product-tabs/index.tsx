      ...
      <div className="grid grid-cols-1 gap-y-8">
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Seu pacote chegará em 3 a 5 dias úteis no local de retirada ou
        ...
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Não ficou como esperado? Sem problemas — trocamos o produto por
              um novo sem complicações.
            </p>
          </div>
        </div>
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Basta devolver o produto e reembolsamos o seu dinheiro. Sem
              perguntas — faremos o possível para tornar sua devolução
              descomplicada.
            </p>
          </div>
        </div>
